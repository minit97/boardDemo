      ...
      <div className="modalContent2">
        <form className="modalForm">
          <div className="modalHeader">
            <button className="delBtn">취소</button>
